...
package com.tuda.whatagame.customview;
...
//        foregroundPaint2 = new Paint(Paint.ANTI_ALIAS_FLAG);
//        foregroundPaint2.setColor(Color.RED);
//        foregroundPaint2.setStyle(Paint.Style.STROKE);
//        foregroundPaint2.setStrokeWidth(strokeWidth);
...
//        if (progress <= 3){
//            canvas.drawArc(rectF, startAngle, -angle, false, foregroundPaint2);
//        }else {
//
//        }
