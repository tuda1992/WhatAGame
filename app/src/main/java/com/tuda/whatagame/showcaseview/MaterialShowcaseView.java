package com.tuda.whatagame.showcaseview;
...
import com.tuda.whatagame.R;
import com.tuda.whatagame.showcaseview.shape.CircleShape;
import com.tuda.whatagame.showcaseview.shape.NoShape;
import com.tuda.whatagame.showcaseview.shape.OvalShape;
import com.tuda.whatagame.showcaseview.shape.RectangleShape;

import com.tuda.whatagame.showcaseview.shape.Shape;
import com.tuda.whatagame.showcaseview.target.Target;
import com.tuda.whatagame.showcaseview.target.ViewTarget;
...
public class MaterialShowcaseView extends FrameLayout implements View.OnTouchListener, View.OnClickListener {
    ...
    private IOnClickScreenListener mListener;

    private boolean isSequence = false;

    public interface IOnClickScreenListener {
        void onClickScreen();
    }
    ...
    public void setListener(IOnClickScreenListener mListener){
    ...
    private void init(Context context) {
        ...
        Button button = (Button) contentView.findViewById(R.id.btn_dissmiss);

        button.setOnClickListener(new OnClickListener() {
            @Override
            public void onClick(View v) {
                hide();
                if (mDismissButton.getText().toString().trim().equalsIgnoreCase("5")) {
                    removeFromWindow();
                    resetAll(getContext());
                    if (mListener != null) {
