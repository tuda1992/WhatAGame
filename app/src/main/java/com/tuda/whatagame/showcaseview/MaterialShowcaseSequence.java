...
public class MaterialShowcaseSequence implements IDetachedListener {
    ...
    public MaterialShowcaseSequence addSequenceItem(MaterialShowcaseView sequenceItem, final OnSequenceItemClickListener listener) {

        if (mConfig != null) {
            sequenceItem.setConfig(mConfig);
        }

        sequenceItem.setListener(new MaterialShowcaseView.IOnClickScreenListener() {
            @Override
    ...
    public interface OnSequenceItemClickListener {
        void onClick();
    }
